(function(e) {
	var t, n, r, i, a, o, s, l, c, u, d, p, h, m = 0,
		...
		D = function() {
			!1 === g.onError(f, m, g) ? (n.hide(), S = !1) : (g.titleShow = !1, g.width = "auto", g.height = "auto", t.html('<p id="fancybox-error">The requested content cannot be loaded.<br />Please try again later.</p>'), L())
		},
		O = function() {
			...
			case "image":
				S = !1, e.fancybox.showActivity(), k = new Image, k.onerror = function() {
					...
					S = !0, k.onerror = k.onload = null, g.width = k.width, g.height = k.height, e("<img />").attr({
						id: "fancybox-img",
						src: k.src,
						alt: g.title
					}).appendTo(t), N()
				...
				break;
			case "swf":
				g.scrolling = "no", s = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="' + g.width + '" height="' + g.height + '"><param name="movie" value="' + r + '"></param>', l = "", e.each(g.swf, function(e, t) {
					s += '<param name="' + e + '" value="' + t + '"></param>', l += " " + e + '="' + t + '"'
				}), s += '<embed src="' + r + '" type="application/x-shockwave-flash" width="' + g.width + '" height="' + g.height + '"' + l + "></embed></object>", t.html(s), L();
				break;
			case "ajax":
		...
		N = function() {
			...
			if (n.hide(), i.is(":visible") && !1 === v.onCleanup(y, b, v)) e.event.trigger("fancybox-cancel"), S = !1;
				...
				}), r.show())) : r.hide(), h = j(), T = v.title || "", x = 0, l.empty().removeAttr("style").removeClass(), v.titleShow !== !1 && (d = e.isFunction(v.titleFormat) ? v.titleFormat(T, y, b, v) : T && T.length ? "float" == v.titlePosition ? '<table id="fancybox-title-float-wrap" cellpadding="0" cellspacing="0"><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">' + T + '</td><td id="fancybox-title-float-right"></td></tr></table>' : '<div id="fancybox-title-' + v.titlePosition + '">' + T + "</div>" : !1, T = d, T && "" !== T)) switch (l.addClass("fancybox-title-" + v.titlePosition).html(T).appendTo("body").show(), v.titlePosition) {
				case "inside":
					l.css({
	...
	e.fn.fancybox = function(t) {
		...
		if (!S && !i.is(":hidden")) if (S = !0, v && !1 === v.onCleanup(y, b, v)) S = !1;
		...
		}), e.support.opacity || i.addClass("fancybox-ie"), R && (n.addClass("fancybox-ie6"), i.addClass("fancybox-ie6"), e('<iframe id="fancybox-hide-sel-frame" src="' + (/^https/i.test(window.location.href || "") ? "javascript:void(false)" : "about:blank") + '" scrolling="no" border="0" frameborder="0" tabindex="-1"></iframe>').prependTo(a)))
