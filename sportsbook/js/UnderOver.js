...
function ShowBetList(Mode, RequestTime, Market, Del, Srt, Ins, uL, uM, uO, uA) {
    ...
    if (Mode == "U") {
        ...
        //Ins=ConvertData(Ins,"UI");
	//uO=ConvertData(uO,"UO");
...
function updateAppendFields(ArrUpdAppend, EventList, MatchMap, DirtyMatchMap) {
    for (var i = 0; i < ArrUpdAppend.length; i++) {
	    ...
	    EventList[idx]["IsBetTrade"] = ArrUpdAppend[i][4];
  	    EventList[idx]["IsMainMarket"] = ArrUpdAppend[i][5];
            idx++;
        }
...
function afterNewEvent_1(HashEvents, Index, HTML, IsLive, BetTypes) {
    ...
    if (fFrame.EnableArrowOddsChange) {
        newHash["Odds_1_H_Cls"] += (oHash["Odds_1_H"] != "") ? " OddsBtn" : "";
        newHash["Odds_1_A_Cls"] += (oHash["Odds_1_A"] != "") ? " OddsBtn" : "";
        newHash["Odds_3_O_Cls"] += (oHash["Odds_3_O"] != "") ? " OddsBtn" : "";
        newHash["Odds_3_U_Cls"] += (oHash["Odds_3_U"] != "") ? " OddsBtn" : "";
        newHash["Odds_7_H_Cls"] += (oHash["Odds_7_H"] != "") ? " OddsBtn" : "";
        newHash["Odds_7_A_Cls"] += (oHash["Odds_7_A"] != "") ? " OddsBtn" : "";
        newHash["Odds_8_O_Cls"] += (oHash["Odds_8_O"] != "") ? " OddsBtn" : "";
        newHash["Odds_8_U_Cls"] += (oHash["Odds_8_U"] != "") ? " OddsBtn" : "";
